...
class SimCLR(nn.Module):
    ...
    """
    def __init__(self, base_encoder, dim=256, mlp_dim=2048, T=0.1, loss_type='dcl', N=50000, num_proj_layers=2, device=None, version='v1'):
        """
...
class all_gather_layer(torch.autograd.Function):
    ...
    #     (input,) = ctx.saved_tensors
    #     grad_out = torch.zeros_like(input)
    #     torch.distributed.reduce_scatter(grad_out, *grads, ReduceOp.SUM, ctx.group)
    #     return grad_out
